...
KeyDetermination.cpp
Author:  Toni

Takes a list of chords that have been heard and compares them against the chords associated with the major keys.
Returns the correct current key
...
int KeyDecider::pickNewKeyMajor(std::list<int> chordsHeardSinceLastKey)
{
	int newKey = 0;
	int currentMax = 0;
...
int KeyDecider::pickNewKey(std::list<int> chordsHeardSinceLastKey) {
